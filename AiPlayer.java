...
public class AiPlayer implements Player {
    ...
    public void removeMinion(int index) {
        // การทำงานของฟังก์ชัน removeMinion ที่จะลบ Minion ตาม id ที่รับมา
        // คุณสามารถกำหนด logic ของการลบ Minion ตามที่ต้องการ
        System.out.println("Removing Minion with ID: " + index);
    }
