...
public class GameStateTest {
    ...
    @BeforeEach
    void setUp() {
        gameBoard = GameBoard.getInstance();  // ใช้ Singleton pattern สำหรับสร้าง instance ของ GameBoard
    ...
    void testPlayerHexesSetup() {
        GameBoard gameBoard = GameBoard.getInstance(); // Create an instance of GameBoard
    ...
    void testCheckCellOwner() {
        ...
        assertEquals(1, gameBoard.checkCellOwner(0, 0), "Expected cell [0][0] to be owned by Player 1");
        ...
        assertEquals(0, gameBoard.checkCellOwner(0, 0), "Expected cell [0][0] to be owned by Player 2");
    }
